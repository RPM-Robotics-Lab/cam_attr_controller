...
%                };
images_names = {
                'sample_pictures2/1.png' 
                'sample_pictures2/5.png'
                'sample_pictures2/12.png' 
                'sample_pictures2/23.png' 
                'sample_pictures2/30.png'
                'sample_pictures2/39.png'
               };
% Natural logarithm of shutter speed for each of the above images 0.05, 7,
% 13.5, 20ms, E = 20
 o_img = imread('sample_pictures2/1.png');
...
E =200;
B = [log(E* (0.00005+ (1 * 0.00005))) log(E* (0.00005+ (4 * 0.00005))) log(E* (0.00005+ (11 * 0.00005))) log(E* (0.00005+ (22 * 0.00005))) log(E* (0.00005+ (29 * 0.00005))) log(E* (0.00005+ (38 * 0.00005)))];
...
response = radiance_map_obj{1}';

csvwrite('crf.csv', response)
...
%     n_exp = in_exp;
    ...
    seq_img=im2double(imread(sprintf('sample_pictures2/%d.png', in_exp+1)));
...
pause(.001)
imwrite(syn_img, sprintf('sample_pictures2/syn%d.png' , in_exp ) );
